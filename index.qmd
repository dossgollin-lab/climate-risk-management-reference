...
However, by definition, these events are rare, meaning few observations exist to objectively estimate their probabilities—this is the challenge of **sampling error**.
While we can try to compensate for limited observations by using models to simulate various weather scenarios and their effects on extreme events, these models inevitably have **biases** that limit their reliability.
