...
## Case Study: How High to Elevate a Levee?

::: {.callout-note}
## Computational Blocks

This is a computational example, but the code isn't included in this chapter.
Rather, all code used to create the figures in this chapter is in the _Notebooks_.
This will be the case for all the computational examples in this reproducible textbook unless explicitly noted (in which case, a reference to the figure will be provided).
:::