...
Studies show that water utilities systematically over-estimate future demand.
...
> The insensitivity of system design to errors, random or otherwise, in the estimates of those parameters affecting design choice [@matalas_planning:1977]
...
In practice, we often have a combination of parametric uncertainties and "model structure" uncertainties [@doss-gollin_subjective:2023].
...
:::: {.columns}
::: {.column width="55%"}
![@doss-gollin_subjective:2023](../_assets/img/lsl-priors-weights.png)
:::
::: {.column width="45%"}
