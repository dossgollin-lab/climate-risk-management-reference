...
This key result shows that the GPD scale parameter is a linear function of the threshold $u$, a property that is used in advanced diagnostics for threshold selection.
