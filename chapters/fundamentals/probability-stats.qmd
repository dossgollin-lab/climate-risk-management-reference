...
Non-stationarity and climate change impacts on statistical properties are discussed in [Fundamentals of Climate Science](/chapters/fundamentals/climate-science.qmd).
...
Spatial and temporal dependence in climate data requires specialized methods covered in [Correlation and Dimensionality](/chapters/fundamentals/correlation-dimensionality.qmd).
...
Spatial dependence and correlation structures are explored in detail in [Correlation and Dimensionality](/chapters/fundamentals/correlation-dimensionality.qmd).
...
The physical processes driving these statistical characteristics are discussed in [Fundamentals of Climate Science](/chapters/fundamentals/climate-science.qmd).
